...
<h1 align="center">Hi, I'm Vandit</h1>

<p align="center">
  Go engineer working on <b>distributed systems</b>, <b>storage</b>, and <b>p2p (libp2p)</b>.<br/>
...
At **FluidCloud**, building a Go cloud scanner (Terraform coverage across 10+ AWS services), observability across microservices (OpenTelemetry to Prometheus/Grafana), and service-to-service auth with Keycloak.
